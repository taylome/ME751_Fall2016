    ...
    methods(Access = public)
        ...
        function Out = Phi_qri_lambda_qri(obj,q,lambda)
            Out = obj.Constraint_CD_1.Phi_qri_lambda_qri( q,lambda(1)) + ...
                  ...
                  obj.Constraint_DP1_1.Phi_qri_lambda_qri( q,lambda(4)) + ...
                  obj.Constraint_DP1_2.Phi_qri_lambda_qri( q,lambda(5));
            if(obj.has_fun)
                  Out = Out + obj.Constraint_DP1_driver.Phi_qri_lambda_qri( q,lambda(6));
            end
        end
        function Out = Phi_qri_lambda_qrj(obj,q,lambda)
            Out = obj.Constraint_CD_1.Phi_qri_lambda_qrj( q,lambda(1)) + ...
                  ...
                  obj.Constraint_DP1_1.Phi_qri_lambda_qrj( q,lambda(4)) + ...
                  obj.Constraint_DP1_2.Phi_qri_lambda_qrj( q,lambda(5));
            if(obj.has_fun)
                  Out = Out + obj.Constraint_DP1_driver.Phi_qri_lambda_qrj( q,lambda(6));
            end
        end
        function Out = Phi_qri_lambda_qpi(obj,q,lambda)
            Out = obj.Constraint_CD_1.Phi_qri_lambda_qpi( q,lambda(1)) + ...
                  ...
                  obj.Constraint_DP1_1.Phi_qri_lambda_qpi( q,lambda(4)) + ...
                  obj.Constraint_DP1_2.Phi_qri_lambda_qpi( q,lambda(5));
            if(obj.has_fun)
                  Out = Out + obj.Constraint_DP1_driver.Phi_qri_lambda_qpi( q,lambda(6));
            end
        end
        function Out = Phi_qri_lambda_qpj(obj,q,lambda)
            Out = obj.Constraint_CD_1.Phi_qri_lambda_qpj( q,lambda(1)) + ...
                  ...
                  obj.Constraint_DP1_1.Phi_qri_lambda_qpj( q,lambda(4)) + ...
                  obj.Constraint_DP1_2.Phi_qri_lambda_qpj( q,lambda(5));
            if(obj.has_fun)
                  Out = Out + obj.Constraint_DP1_driver.Phi_qri_lambda_qpj( q,lambda(6));
            end
        end
        ...
        function Out = Phi_qrj_lambda_qri(obj,q,lambda)
            Out = obj.Constraint_CD_1.Phi_qrj_lambda_qri( q,lambda(1)) + ...
                  ...
                  obj.Constraint_DP1_1.Phi_qrj_lambda_qri( q,lambda(4)) + ...
                  obj.Constraint_DP1_2.Phi_qrj_lambda_qri( q,lambda(5));
            if(obj.has_fun)
                  Out = Out + obj.Constraint_DP1_driver.Phi_qrj_lambda_qri( q,lambda(6));
            end
        end
        function Out = Phi_qrj_lambda_qrj(obj,q,lambda)
            Out = obj.Constraint_CD_1.Phi_qrj_lambda_qrj( q,lambda(1)) + ...
                  ...
                  obj.Constraint_DP1_1.Phi_qrj_lambda_qrj( q,lambda(4)) + ...
                  obj.Constraint_DP1_2.Phi_qrj_lambda_qrj( q,lambda(5));
            if(obj.has_fun)
                  Out = Out + obj.Constraint_DP1_driver.Phi_qrj_lambda_qrj( q,lambda(6));
            end
        end
        function Out = Phi_qrj_lambda_qpi(obj,q,lambda)
            Out = obj.Constraint_CD_1.Phi_qrj_lambda_qpi( q,lambda(1)) + ...
                  ...
                  obj.Constraint_DP1_1.Phi_qrj_lambda_qpi( q,lambda(4)) + ...
                  obj.Constraint_DP1_2.Phi_qrj_lambda_qpi( q,lambda(5));
            if(obj.has_fun)
                  Out = Out + obj.Constraint_DP1_driver.Phi_qrj_lambda_qpi( q,lambda(6));
            end
        end
        function Out = Phi_qrj_lambda_qpj(obj,q,lambda)
            Out = obj.Constraint_CD_1.Phi_qrj_lambda_qpj( q,lambda(1)) + ...
                  ...
                  obj.Constraint_DP1_1.Phi_qrj_lambda_qpj( q,lambda(4)) + ...
                  obj.Constraint_DP1_2.Phi_qrj_lambda_qpj( q,lambda(5));
            if(obj.has_fun)
                  Out = Out + obj.Constraint_DP1_driver.Phi_qrj_lambda_qpj( q,lambda(6));
            end
        end
        ...
        function Out = Phi_qpi_lambda_qri(obj,q,lambda)
            Out = obj.Constraint_CD_1.Phi_qpi_lambda_qri( q,lambda(1)) + ...
                  ...
                  obj.Constraint_DP1_1.Phi_qpi_lambda_qri( q,lambda(4)) + ...
                  obj.Constraint_DP1_2.Phi_qpi_lambda_qri( q,lambda(5));
            if(obj.has_fun)
                  Out = Out + obj.Constraint_DP1_driver.Phi_qpi_lambda_qri( q,lambda(6));
            end
        end
        function Out = Phi_qpi_lambda_qrj(obj,q,lambda)
            Out = obj.Constraint_CD_1.Phi_qpi_lambda_qrj( q,lambda(1)) + ...
                  ...
                  obj.Constraint_DP1_1.Phi_qpi_lambda_qrj( q,lambda(4)) + ...
                  obj.Constraint_DP1_2.Phi_qpi_lambda_qrj( q,lambda(5));
            if(obj.has_fun)
                  Out = Out + obj.Constraint_DP1_driver.Phi_qpi_lambda_qrj( q,lambda(6));
            end
        end
        function Out = Phi_qpi_lambda_qpi(obj,q,lambda)
            Out = obj.Constraint_CD_1.Phi_qpi_lambda_qpi( q,lambda(1)) + ...
                  ...
                  obj.Constraint_DP1_1.Phi_qpi_lambda_qpi( q,lambda(4)) + ...
                  obj.Constraint_DP1_2.Phi_qpi_lambda_qpi( q,lambda(5));
            if(obj.has_fun)
                  Out = Out + obj.Constraint_DP1_driver.Phi_qpi_lambda_qpi( q,lambda(6));
            end
        end
        function Out = Phi_qpi_lambda_qpj(obj,q,lambda)
            Out = obj.Constraint_CD_1.Phi_qpi_lambda_qpj( q,lambda(1)) + ...
                  ...
                  obj.Constraint_DP1_1.Phi_qpi_lambda_qpj( q,lambda(4)) + ...
                  obj.Constraint_DP1_2.Phi_qpi_lambda_qpj( q,lambda(5));
            if(obj.has_fun)
                  Out = Out + obj.Constraint_DP1_driver.Phi_qpi_lambda_qpj( q,lambda(6));
            end
        end
        ...
        function Out = Phi_qpj_lambda_qri(obj,q,lambda)
            Out = obj.Constraint_CD_1.Phi_qpj_lambda_qri( q,lambda(1)) + ...
                  ...
                  obj.Constraint_DP1_1.Phi_qpj_lambda_qri( q,lambda(4)) + ...
                  obj.Constraint_DP1_2.Phi_qpj_lambda_qri( q,lambda(5));
            if(obj.has_fun)
                  Out = Out + obj.Constraint_DP1_driver.Phi_qpj_lambda_qri( q,lambda(6));
            end
        end
        function Out = Phi_qpj_lambda_qrj(obj,q,lambda)
            Out = obj.Constraint_CD_1.Phi_qpj_lambda_qrj( q,lambda(1)) + ...
                  ...
                  obj.Constraint_DP1_1.Phi_qpj_lambda_qrj( q,lambda(4)) + ...
                  obj.Constraint_DP1_2.Phi_qpj_lambda_qrj( q,lambda(5));
            if(obj.has_fun)
                  Out = Out + obj.Constraint_DP1_driver.Phi_qpj_lambda_qrj( q,lambda(6));
            end
        end
        function Out = Phi_qpj_lambda_qpi(obj,q,lambda)
            Out = obj.Constraint_CD_1.Phi_qpj_lambda_qpi( q,lambda(1)) + ...
                  ...
                  obj.Constraint_DP1_1.Phi_qpj_lambda_qpi( q,lambda(4)) + ...
                  obj.Constraint_DP1_2.Phi_qpj_lambda_qpi( q,lambda(5));
            if(obj.has_fun)
                  Out = Out + obj.Constraint_DP1_driver.Phi_qpj_lambda_qpi( q,lambda(6));
            end
        end
        function Out = Phi_qpj_lambda_qpj(obj,q,lambda)
            Out = obj.Constraint_CD_1.Phi_qpj_lambda_qpj( q,lambda(1)) + ...
                  ...
                  obj.Constraint_DP1_1.Phi_qpj_lambda_qpj( q,lambda(4)) + ...
                  obj.Constraint_DP1_2.Phi_qpj_lambda_qpj( q,lambda(5));
            if(obj.has_fun)
                  Out = Out + obj.Constraint_DP1_driver.Phi_qpj_lambda_qpj( q,lambda(6));
            end
        end
